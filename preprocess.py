...
full_data = np.loadtxt(fname='./datasets/CMAPSSData/train_FD003.txt', dtype=np.float32)
full_test = np.loadtxt(fname='./datasets/CMAPSSData/test_FD003.txt', dtype=np.float32)
...
np.savetxt('./datasets/CMAPSSData/train_FD003_normed.txt', output_data, fmt='%f')
np.savetxt('./datasets/CMAPSSData/test_FD003_normed.txt', output_test, fmt='%f')